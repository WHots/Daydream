...
unsafe extern "system" {
    ...
    pub(crate) fn nt_query_object(handle: HANDLE, object_information_class: i32, object_information: *mut c_void, object_information_length: u32, return_length: *mut u32) -> NTSTATUS;
    ...
    pub(crate) fn nt_query_information_process(process: HANDLE, process_information_class: i32, process_information: *mut c_void, process_information_length: u32, return_length: *mut u32) -> NTSTATUS;
    ...
    pub(crate) fn nt_read_virtual_memory(process: HANDLE, base_address: *const c_void, buffer: *mut c_void, number_of_bytes_to_read: usize, number_of_bytes_read: *mut usize) -> NTSTATUS;
    ...
    pub(crate) fn nt_query_virtual_memory(process: HANDLE, base_address: *const c_void, memory_information_class: i32, memory_information: *mut c_void, memory_information_length: usize, return_length: *mut usize) -> NTSTATUS;
}
