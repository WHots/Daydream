...
pub const X64_BREAKPOINT_OPCODE_BYTECODES: &[OpcodeBytecode] = &[INT3_BREAKPOINT, INT_VECTOR_3_BREAKPOINT, INT_VECTOR_1_DEBUG_INTERRUPT, INT1_ICEBP_DEBUG_TRAP, MOV_FROM_DEBUG_REGISTER, MOV_TO_DEBUG_REGISTER];
